      ...
      <div className="relative z-10 w-full max-w-[440px] rounded-[22px] border border-[#1b4d99] bg-[linear-gradient(180deg,#021839_0%,#010d27_100%)] p-5 shadow-[0_22px_55px_rgba(0,0,0,0.6)]">
        ...
        <div className="mt-4">
          ...
          >
            ...
            <button disabled={loading} className="h-11 rounded-xl border border-[#2c78df] bg-[linear-gradient(180deg,#1557cf_0%,#0c45b9_100%)] text-sm font-semibold text-white transition hover:brightness-110 disabled:opacity-60">{loading ? "Please wait..." : step === "password" ? "Send OTP" : "Verify & Login"}</button>
          </form>
          {step === "otp" ? (
            <button
              type="button"
